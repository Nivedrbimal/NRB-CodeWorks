...
function showElementInfo(symbol) {
  ...
  if (element) {
    ...
    document.getElementById("isotope-name").textContent = "Name: " + element.Isotopes.Name;
    document.getElementById("isotope-symbol").textContent = "Symbol: " + element.Isotopes.Symbol;
    document.getElementById("isotope-neutrons").textContent = "Neutrons: " + element.Isotopes.Neutrons;
    document.getElementById("isotope-mass").textContent = "Mass: " + element.Isotopes.Mass;
    document.getElementById("isotope-mass-excess").textContent = "Mass Excess: " + element.Isotopes.Mass_Excess;
    document.getElementById("element-info-out-natural").textContent = "Natural Abundance: " + element.Isotopes.Abundances.Natural;
    document.getElementById("element-info-out-solar").textContent = "Solar Abundance: " + element.Isotopes.Abundances.Solar;
    document.getElementById("element-info-out-universe").textContent = "Universe Abundance: " + element.Isotopes.Abundances.Universe;
    document.getElementById("isotope-binding-energy").textContent = "Binding Energy: " + element.Isotopes.Binding_Energy;
    document.getElementById("isotope-decay-energy").textContent = "Decay Energy: " + element.Isotopes.Decay_Energy;
    document.getElementById("isotope-decay-mode").textContent = "Decay Mode: " + element.Isotopes.Decay_Mode;
    document.getElementById("isotope-decay-width").textContent = "Decay Width: " + element.Isotopes.Decay_Width;
    document.getElementById("isotope-half-life").textContent = "Half-Life: " + element.Isotopes.Half_Life;
    document.getElementById("isotope-mag-moment").textContent = "Magnetic Moment: " + element.Isotopes.Magnetic_Moment;
    document.getElementById("isotope-quadrupole").textContent = "Quadrupole Moment: " + element.Isotopes.Quadrupole_Moment;
    document.getElementById("isotope-specific-activity").textContent = "Specific Activity: " + element.Isotopes.Specific_Activity;
    document.getElementById("isotope-spin").textContent = "Spin: " + element.Isotopes.Spin;
    document.getElementById("isotope-notes").textContent = "Notes: " + element.Isotopes.Notes;
    document.getElementById("isotope-use").textContent = "Use: " + element.Isotopes.Use;
